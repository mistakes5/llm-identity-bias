"""Experiment 4 runner: profile bias in subjective / aesthetics responses.
...
PROFILE_TYPES: dict[str, str] = {
    ...
    "D": "high_sophistication_domain_relevant",
    "E": "low_sophistication_domain_relevant",
}
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Experiment 4: profile bias in subjective analysis")
